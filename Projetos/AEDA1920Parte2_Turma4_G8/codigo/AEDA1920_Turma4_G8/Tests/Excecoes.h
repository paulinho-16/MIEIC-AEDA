...
/// \brief Exceção: Quando o condominio não é encontrado
class Condominio_Nao_Encontrado{
    /// \brief Numero de Habitacoes do condominio não encontrado
    int numero;
public:
    /// \brief Construtor da exceção com a seguinte informação
    /// \param n : Numero de Habitacoes do condominio não encontrado
    Condominio_Nao_Encontrado(int n) {numero = n;}
};
...
/// \brief Exceção: Quando o transporte não é encontrado
class Transporte_Nao_Encontrado{
    /// \brief Destino do transporte não encontrado
    string destino;
public:
    /// \brief Construtor da exceção com a seguinte informação
    /// \param d: destino do transporte não encontrado
    Transporte_Nao_Encontrado(string d) {destino = d;}
};
