...
class Condomino {
    ...
    /// \brief A data de entrada no condomínio.
...
public:
    ...
    /// \brief Devolve a data de entrada no condomínio do Condómino.
    /// \return A data de entrada no condomínio do Condómino.
    const tm getDataEntrada() const;

    /// \brief Modifica a data de entrada no condomínio do Condómino.
    /// \param dataEntrada: A nova data de entrada no condomínio do Condómino.
    void setDataEntrada(const tm &de);
    ...
    /// \return true se o condomino recebido representar um condomino com o mesmo NIF. Caso contrário, retorna false.
